     ...
     <footer class="footer-annonces">
        ...
        <aside class="l-nav-aside hide-menu" >
            ...
            <ul class="l-nav-big">
                ...
                <li><a href="<?php echo site_url('rappels/index'); ?>" class='<?php if($pagename == "rappels") echo "active"; ?>'><i class="fa fa-phone"></i> <strong class="alert-tag rappels"><?php echo $user->count_rappels; ?></strong><span ><?php echo $this->lang->line('my_remembers'); ?></span></a></li>
